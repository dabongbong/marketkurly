              ...
              <form name="form1">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <input type="hidden" class="form-control" name="admin_id" id="admin_id"  value="<%=admin.getAdmin_id() %>" >
                  <label for="id">아이디</label>
                    <input type="text" class="form-control" name="user_id" id="user_id"  value="<%=admin.getUser_id() %>"  placeholder="아이디를 입력해주세요" >
                  ...
                  <label for="name">이름</label>
                     <input type="text" class="form-control" value="<%=admin.getName() %>" name="name" id="name"  placeholder="이름을 입력해주세요" required>
                    <div class="check_font" id="name_check"></div>
                    
                <!-- /.card-body -->

                <div class="card-footer">
                  <button type="button" class="btn btn-info" id="reg" onClick="del()">삭제</button>
                </div>
              </form>
            </div>
...
function del(){
	if(confirm("삭제하시겠습니까?")){
		location.href="/admin/login/delete?admin_id=<%=admin.getAdmin_id()%>";
	}
}
