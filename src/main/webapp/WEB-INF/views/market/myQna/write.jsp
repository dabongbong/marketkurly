		...
		<div class="row">
			<div class="col-lg-12">
				<div class="breadcrumb-text">
					<a href="#"><i class="fa fa-home"></i> Home</a> <span>1:1
						문의작성</span>
				</div>
			</div>
		</div>
...
<div class="container">
	<div class="row">
		...
		<form name="form1">
			...
			<div class="form-group">
				<input type="text" placeholder="이메일 입력"> <input type="checkbox" name="emailChk">답변 수신을 이메일로 받겠습니다.
			</div>

			<div class="form-group">
				<input type="text" placeholder="전화번호 입력"> <input type="checkbox" name="messagechk">답변 수신을 문자메세지로 받겠습니다.
			</div>
			<div>
				<font size="4em" style="font-weight: bold;">1:1 문의 작성 전 확인해주세요!</font>
				<p><p>
				<div>
			...
			<div class="card-footer">
				<button type="button" class="btn btn-info"
					style="background-color: #5F0080" id="bt_write">등록</button>
				<button type="button" class="btn btn-info"
					style="background-color: #5F0080"
					onClick="location.href='/myQnaList'">목록</button>
			</div>
		</div>
	</div>
	</form>
...
<script>
	/* 텍스트에리아 자동 높이 조절 글을 쓰면 알아서 높이가 조절됨 */
