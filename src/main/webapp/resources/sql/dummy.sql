...
-- 홍길동=1, 심청이=2 --
insert into member(member_pass, member_name, email, phone, addr, gender, birth) 
values('1234','홍길동','redRoadEast@naver.com','01012341234','경기도 의왕시','남자','19980206');
insert into member(member_pass, member_name, email, phone, addr, gender, birth) 
values('1234','심청이','mindBlue2@naver.com','01198765432','서울시 강남구','여자','19710505');
 -- 팬시레몬 2개, 아보카도 5개 --
-- 샤인마토 2개 --
-- 유명산지 한판딸기 1개 --
-- 칠레산 생체리 2개, 친환경 당근 1개 --
-- 샤인마토 아보카도 팽이버섯 애호박 감자  생체리 1개씩-
insert into order_summary(member_id,paymethod_id,price) values(1, 1, 12924);
insert into order_summary(member_id,paymethod_id,price) values(2, 1, 27500); 
insert into order_summary(member_id,paymethod_id,price) values(1, 1, 16020); 
insert into order_summary(member_id,paymethod_id,price) values(2, 1, 2150); 
insert into order_summary(member_id,paymethod_id,price) values(2, 1, 28512);
